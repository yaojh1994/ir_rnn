...
#from tensorflow.model.rnn.ptb import reader
import reader
from tensorlayer.iterate import ptb_iterator
...
flags.DEFINE_string("data_path", '/home/ipython/yaojiahui/My_Tensorflow/data/simple-examples/data', "data_path")
...
class PTBModel(object):
    ...
    def __init__(self, is_training, config):
        ...
        '''
        cell = tf.nn.rnn_cell.MultiRNNCell([self.lstm_cell(size, is_training) for _ in range(config.num_layers)], state_is_tuple = True)
    ...
    def lstm_cell(self, size, is_training):
